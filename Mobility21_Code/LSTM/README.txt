...
read_data.py
Reads motion patterns data from the Argo mixture models files.

vanilla_LSTM_scratch.py
Scratch file that applies vanilla LSTM to motion patterns in Argo mixture models.
